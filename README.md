# vite-plugin-svg-icons2

Base [vite-plugin-svg-icons](https://github.com/vbenjs/vite-plugin-svg-icons) to develop and maintain
...
```bash
yarn add vite-plugin-svg-icons2 -D
# or
npm i vite-plugin-svg-icons2 -D
# or
pnpm install vite-plugin-svg-icons2 -D
```
